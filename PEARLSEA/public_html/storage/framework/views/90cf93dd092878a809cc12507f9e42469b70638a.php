...
<?php $__env->startSection('content_section'); ?>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade in active" id="select-room">
                                    <div class="mg-available-rooms">
                                        <h2 class="mg-sec-left-title"><?php echo e($constants['booking']['available']); ?></h2>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <h3 class="mg-avl-room-title"><a href="#"><?php echo e($room->name); ?></a>
                                                            <span id ="room-price"><?php echo e(number_format($room->price, 0)); ?></span></h3>

                                                        <p><span><?php echo e($room->description); ?></span> -
                                                            <span><?php echo e($room->total_person); ?> <?php echo e($constants['room']['person']); ?></span>
                                                        </p>
                                                        ...
                                                        <?php if($booking->room_id == $room->id): ?>
                                                            <a href="#personal-info" rid="<?php echo e($room->id); ?>" id="step1"
                                                               class="btn btn-success btn-next-tab"><?php echo e($constants['booking']['continue']); ?></a>

                                                        <?php else: ?>
                                                            <a href="#personal-info" rid="<?php echo e($room->id); ?>" id="step1"
                                                               class="btn btn-main btn-next-tab"><?php echo e($constants['booking']['select']); ?></a>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="mg-book-form-personal">
                                                <h2 class="mg-sec-left-title"><?php echo e($constants['booking']['step2']); ?></h2>
                                                ...
                                                <div class="row pb40">
                                                            ...
                                                            <div class="mg-book-form-input">
                                                                <div class="input-group date mg-check-in">
                                                                    ...
                                                                    <input type="text" class="form-control" id="booking-checkin"
                                                                           ...
                                                                           placeholder="<?php echo e($constants['booknow']['checkin']); ?>">

                                                                </div>
                                                                <div style="display:none;" class="alert alert-warning"
                                                                     role="alert"><i
                                                                            class="fa fa-warning"></i> <?php echo e($constants['validate']['checkin']); ?>
                                                            ...
                                                            <div class="mg-book-form-input">
                                                                <div class="input-group date mg-check-out">
                                                                    ...
                                                                    <input type="text" class="form-control" id="booking-checkout"
                                                                           ...
                                                                           placeholder="<?php echo e($constants['booknow']['checkout']); ?>">
                                                                </div>
                                                                <div style="display:none;" class="alert alert-warning"
                                                                     role="alert"><i
                                                                            class="fa fa-warning"></i> <?php echo e($constants['validate']['checkout']); ?>
                                                            ...
                                                            <div class="mg-book-form-input">
                                                                <select class="cs-select cs-skin-elastic form-control"
                                                                    ...
                                                                    <option value="" disabled
                                                                            selected><?php echo e($constants['booknow']['adult']); ?></option>
                                                        ...
                                                        <div class="col-md-6" style="z-index: 0;">
                                                            <div class="mg-book-form-input">
                                                                <select class="cs-select cs-skin-elastic form-control"
                                                                    ...
                                                                    <option value="" disabled
                                                                            selected><?php echo e($constants['booknow']['child']); ?></option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                            <div class="mg-book-form-input">
                                                                <label><?php echo e($constants['booking']['firstname']); ?></label>
                                                                ...
                                                                <div style="display:none;" class="alert alert-warning"
                                                                     role="alert"><i
                                                                            class="fa fa-warning"></i> <?php echo e($constants['validate']['firstname']); ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mg-book-form-input">
                                                                <label><?php echo e($constants['booking']['lastname']); ?></label>
                                                                ...
                                                                <div style="display:none;" class="alert alert-warning"
                                                                     role="alert"><i
                                                                            class="fa fa-warning"></i> <?php echo e($constants['validate']['lastname']); ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                            <div class="mg-book-form-input">
                                                                <label><?php echo e($constants['booking']['email']); ?></label>
                                                                ...
                                                                <div style="display:none;" class="alert alert-warning"
                                                                     role="alert"><i
                                                                            class="fa fa-warning"></i> <?php echo e($constants['validate']['email']); ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mg-book-form-input">
                                                                <label><?php echo e($constants['booking']['email2']); ?></label>
                                                                ...
                                                                <div style="display:none;" class="alert alert-warning"
                                                                     role="alert"><i
                                                                            class="fa fa-warning"></i> <?php echo e($constants['validate']['email2']); ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-6">
                                                            <div class="mg-book-form-input">
                                                                <label><?php echo e($constants['booking']['phone']); ?></label>
                                                                ...
                                                                <div style="display:none;" class="alert alert-warning"
                                                                     role="alert"><i
                                                                            class="fa fa-warning"></i> <?php echo e($constants['validate']['phone']); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mg-cart-container">
                                                <aside class="mg-widget mt50" id="mg-room-cart">
                                                    <h2 class="mg-widget-title"><?php echo e($constants['booking']['detail']); ?></h2>

                                                    <div class="mg-widget-cart">
                                                        <div class="mg-cart-room">
                                                            <img id="booking-room-url" src="<?php echo e(asset('images/room.jpg')); ?>" alt="pearlsea" class="img-responsive">

                                                            <h3 id="booking-room-name"></h3>
                                                        </div>
                                                        <div class="mg-widget-cart-row">
                                                            <strong><?php echo e($constants['booknow']['checkin']); ?>:</strong>
                                                            <span id="booking-checkin-txt"></span>
                                                        </div>
                                                        <div class="mg-widget-cart-row">
                                                            <strong><?php echo e($constants['booknow']['checkout']); ?>:</strong>
                                                            <span id="booking-checkout-txt"></span>
                                                        </div>
                                                        <div class="mg-widget-cart-row">
                                                            <strong><?php echo e($constants['booknow']['adult']); ?>:</strong>
                                                            <span id="booking-adult-txt">0</span>
                                                        </div>
                                                        <div class="mg-widget-cart-row">
                                                            <strong><?php echo e($constants['booknow']['child']); ?>:</strong>
                                                            <span id="booking-child-txt">0</span>
                                                        </div>
                                                        <div class="mg-cart-total">
                                                            <strong><?php echo e($constants['booking']['total']); ?>:</strong>
                                            ...
                                            <div class="clearfix mg-terms-input">
                                                <div class="pull-right">
                                                    <label><input id="accept"
                                                                  type="checkbox"> <?php echo e($constants['booking']['confirm']); ?>

                                                        <a
                                                                href="#"><?php echo e($constants['booking']['terms']); ?></a></label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="mg-book-form-billing">
                                                <h2 class="mg-sec-left-title"><?php echo e($constants['booking']['paylater']); ?></h2>

                                                <h3><?php echo e($constants['booking']['devlater']); ?></h3>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mg-cart-container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a href="#thank-you" id="step3"
                                               class="btn btn-dark-main btn-next-tab pull-right"><?php echo e($constants['booking']['pay']); ?></a>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="thank-you">
                                    <div class="alert alert-success alert-dismissible clearfix">
                                        ...
                                        <h3 class="mg-alert-payment"
                                            style="display: inline;"><?php echo e($constants['booking']['thankyou']); ?></h3>
                                    </div>
                                    ...
                                    <aside class="mg-widget mt50" id="mg-room-cart">
                                        ...
                                        <div class="mg-widget-cart">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <h3 class="mg-payment-id"><?php echo e($constants['booking']['payId']); ?>: #<span id="booking-id-txt"></span></h3>   
                                                    <div class="mg-widget-cart-row">
                                                        <strong><?php echo e($constants['booknow']['checkin']); ?>:</strong>
                                                        <span id="booking-checkin-txt"></span>
                                                    </div>
                                                    ...
                                                    <div class="mg-cart-address">
                                                            <strong><?php echo e($constants['contact']['full_name']); ?>:</strong>
                                                            <address>
    ...
    <script type="text/javascript">
         ...
         var session_total = 0;
         var isBooking = false;
           <?php if(Session::has('booking') && ! empty(Session::get('booking')->check_in)): ?>
                session_checkin = '<?php echo e(date('d/m/Y', strtotime(Session::get('booking')->check_in))); ?>';
            <?php endif; ?>

            
            <?php if(Session::has('booking') && ! empty(Session::get('booking')->check_out)): ?>
                session_checkout = '<?php echo e(date('d/m/Y', strtotime(Session::get('booking')->check_out))); ?>';
            <?php endif; ?>

           
            <?php if(Session::has('booking') && ! empty(Session::get('booking')->adult)): ?>
                session_adult = '<?php echo e(Session::get('booking')->adult); ?>';
                    <?php endif; ?>

            
            <?php if(Session::has('booking') && ! empty(Session::get('booking')->child)): ?>
                session_child = '<?php echo e(Session::get('booking')->child); ?>';
            <?php endif; ?>

            <?php if(Session::has('booking') && ! empty(Session::get('booking')->total_money)): ?>
                session_total = '<?php echo e(Session::get('booking')->total_money); ?>';
            <?php endif; ?>
        ...
        function selectRoom(roomId) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(URL(Session::get('lang').'/booking/select')); ?>',
                data: {roomId: roomId},
                success: function (data) {
                    if (data.success) {
                        ...
                        window.location.href = '<?php echo e(URL(Session::get('lang').'/booking')); ?>';
                    }
                },
                error: function () {
                    window.location.href = '<?php echo e(URL(Session::get('lang').'/booking')); ?>';
        ...
        function makeBooking() {
            $.ajax({
                type: "POST",
                url: '<?php echo e(URL(Session::get('lang').'/booking/make')); ?>',
                data: {},
                success: function (data) {
                    if (data.success) {
        ...
        function userInfo() {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(URL(Session::get('lang').'/booking/userInfo')); ?>',
                data: {
                    checkin: checkin,
                    checkout: checkout,
                    adult: adult,
