...
<table class="table table-hover table-bordered table-condensed">
    ...
    <?php foreach($tours as $tour): ?>
        ...
        <?php else: ?>
            <tr>
                <?php endif; ?>
                <td><b><?php echo e($tour->id); ?></b></td>
                <td><?php echo e($tour->duration); ?></td>
                <td><?php echo e($tour->departure); ?></td>
                <td><?php echo e($tour->arrival); ?></td>
                <td><?php echo e($tour->price); ?></td>
                <td><?php echo e($tour->note); ?></td>
                <td><?php if(! empty($tour->imageUrl)): ?>
                  <img width ="50" t-url="<?php echo e($tour->imageUrl); ?>" src="<?php echo e(asset($tour->imageUrl)); ?>" alt="pearl sea hotel">
                <?php endif; ?></td>
                <td><input type="button" class="btn btn-xs btn-danger" value="Sửa"  t-id="<?php echo e($tour->id); ?>" onclick="openEditTour(this)"/></td>     
                <td><input type="button" class="btn btn-xs btn-danger" value="Xóa" onclick="deleteTour(<?php echo e($tour->id); ?>)"/></td>
            </tr>
            <?php endforeach; ?>
...
<div>
    <div style="text-align:center;" id="tour-paging"><?php echo e($tours->links()); ?></div>
</div>
