            ...
            <form class="clearfix">
                <div class="mg-contact-form-input" style="display:none">
                    <input type="text" class="form-control" id="contact_id"
                           disabled value="<?php echo e($contact->id); ?>">
                </div>
                <div class="mg-contact-form-input">
                    <label for="email">Tên hiển thị</label>
                    <input type="text" class="form-control" id="name" value="<?php echo e($contact->name); ?>">
                </div>
                <div class="mg-contact-form-input">
                    <label for="email">Email</label>
                    <input type="text" class="form-control" id="email" value="<?php echo e($contact->email_to); ?>">
                </div>
                <div class="mg-contact-form-input">
                ...
                <div class="mg-contact-form-input">
                    ...
                    <input type="text" class="form-control" id="phone" value="<?php echo e($contact->phone); ?>">
                </div>
                <div class="mg-contact-form-input">
                    <label for="content">Địa chỉ</label>
                    <textarea class="form-control" id="address"
                              rows="5"><?php echo e($contact->address); ?></textarea>
                </div>
